...
class QuizState(rx.State):
    ...
    personalities: dict[str, Personality] = {
        "S": {
            ...
            "icon": "ghost",
            "spots": ["ldp-lecture-phantom", "ldp-stealth-stairs"],
        },
        "C": {
            ...
            "icon": "couch",
            "spots": ["cdm-sofa-paradise", "cdm-modular-dreams", "cdm-curtain-instance"],
        },
        "R": {
            ...
            "spots": ["pnp-milk-tea-dreams", "cdm-ergonomic-island"],
        },
        "A": {
            ...
            "icon": "earth",
            "spots": ["pms-urban-sleeper", "pms-umbrella-universe", "pms-stone-zen"],
        },
        "SR": {
            ...
            "icon": "book-user",
            "spots": ["ldp-lecture-phantom", "cdm-ergonomic-island"],
        },
        "Default": {
